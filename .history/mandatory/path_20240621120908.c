...
/*   Updated: 2024/06/21 12:09:08 by hanebaro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//     dirs = ft_split(path_env, ':');
//     for (i = 0; dirs[i]; i++) {
//         // Concaténation en une seule étape pour éviter les fuites de mémoire
//         full_path = malloc(strlen(dirs[i]) + 1 + strlen(argv) + 1);
//         if (!full_path) {
//             ft_free_split(dirs);
//             return NULL; // Gérer l'erreur de malloc
//         }
